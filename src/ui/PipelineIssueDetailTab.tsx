...
const css = {
  container: { fontFamily: "system-ui, sans-serif", fontSize: "13px", padding: "16px", display: "grid", gap: "16px" } as React.CSSProperties,
  ...
  section: { border: "1px solid #e5e7eb", borderRadius: "8px", padding: "12px" } as React.CSSProperties,
  sectionTitle: { fontSize: "14px", fontWeight: 600, marginBottom: "8px" } as React.CSSProperties,
  stepRow: { display: "flex", alignItems: "center", gap: "8px", padding: "6px 8px", borderRadius: "6px", marginBottom: "4px", background: "#f9fafb" } as React.CSSProperties,
  stepNum: { fontWeight: 600, color: "#6b7280", minWidth: "24px" } as React.CSSProperties,
  stepAgent: { fontWeight: 500, flex: 1 } as React.CSSProperties,
  stepRole: { color: "#6b7280", fontSize: "12px" } as React.CSSProperties,
  ...
  btnSmall: { padding: "2px 8px", fontSize: "11px", borderRadius: "4px", border: "1px solid #d1d5db", background: "#fff", cursor: "pointer" } as React.CSSProperties,
  select: { padding: "4px 8px", fontSize: "12px", borderRadius: "4px", border: "1px solid #d1d5db", flex: 1 } as React.CSSProperties,
  input: { padding: "4px 8px", fontSize: "12px", borderRadius: "4px", border: "1px solid #d1d5db", width: "120px" } as React.CSSProperties,
  ...
  arrow: { color: "#9ca3af", fontSize: "11px" } as React.CSSProperties,
  empty: { color: "#9ca3af", fontSize: "13px", fontStyle: "italic" as const, textAlign: "center" as const, padding: "24px" } as React.CSSProperties,
  templateRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "4px 0" } as React.CSSProperties,
  error: { color: "#dc2626", fontSize: "12px", marginTop: "4px" } as React.CSSProperties,
};
  ...
  if (editMode) {
    return (
      <div style={css.container}>
        ...
        {templates.length > 0 && (
          <div>
            <span style={{ fontSize: "12px", color: "#6b7280" }}>Load template: </span>
            {templates.map((t) => (
        ...
        <div style={css.section}>
          ...
          {editSteps.map((step, idx) => (
            <div key={idx} style={css.stepRow}>
              ...
              <button style={{ ...css.btnSmall, color: "#dc2626" }} onClick={() => removeStep(idx)}>
                &times;
              </button>
            </div>
          ))}
